function PLSAngel(len_N,neighborhood_structure,centro,numCentro)
    ...
    name = "memArchivoPLSAngel_$(numCentro)_$(len_N)_$(neighborhood_structure)_$(prioridad)_Epsilon_$(minEpsilon)-$(maxEpsilon)"
    filename = name*".txt"
    ...
    name = "expPLSAngel_$(numCentro)_$(len_N)_$(neighborhood_structure)_$(prioridad)_Epsilon_$(minEpsilon)-$(maxEpsilon)"
    filename = name*".txt"
    open(filename, "w") do file
