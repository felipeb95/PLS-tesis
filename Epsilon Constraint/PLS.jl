function PLS(len_N,neighborhood_structure,e,centro,numCentro)
    ...
    name = "memArchivoPLSPaquete_$(numCentro)_$(e)_$(len_N)_$(neighborhood_structure)_$(prioridad)";
    filename = name*".txt"
    ...
    name = "expPLSPaquete_$(numCentro)_$(e)_$(len_N)_$(neighborhood_structure)_$(prioridad)";
    filename = name*".txt"
    open(filename, "w") do file
